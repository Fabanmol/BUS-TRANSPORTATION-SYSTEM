...
<div class="tab">
	...
	<div id="form">
	<form name="form" id="form" method="post" action="addbus1.php" >
			<label>BUS NUMBER</label>:<input type="number" maxlength="20" name="bus_no" id="bus_no" autocomplete="on" required ><br/>
			<label>ENGINE NUMBER</label>:<input type="number" maxlength="10" id="engine_number" name="engine_number" required ><br/>
			<label>TYRE COMPANY</label>:<input type="text" maxlength="10" id="tyre_company" name="tyre_company" required ><br/>
			<label>DRIVER NAME</label>:<input type="text" name="driver_name" id="driver_name" maxlength="10" ><br>
			<label>CONDUCTOR NAME</label>:<input type="text" name="conductor_name" id="conductor_name" maxlength="10" ><br>
			<br><br>
