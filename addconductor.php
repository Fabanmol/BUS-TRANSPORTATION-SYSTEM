...
<div class="tab">
	...
	<div id="form">
	<form name="form" id="form" method="post" action="addconductor1.php" >
			<label>CONDUCTOR ID</label>:<input type="number" maxlength="20" name="conductor_id" id="conductor_id" autocomplete="on" required ><br/>
