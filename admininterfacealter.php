...
<!-- Space for search tabs-->
			<div style="margin:2%;height:96%;border-radius:5px;background-color:grey">
				<div style="background-color:#333;width:100%;height:30px;">
					<font style="font-size:150%; color:white;font-family: caviar;text-align: left;">ALTER</font>
				</div>
				<br><br>
				<form autocomplete="off" action="find.html" method="get">
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="addbus.php">ADD BUS</a>  
					...
					<br>
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="deletebus.php">DELETE BUS</a>  
						 		<div class="autocomplete" style="width:100%">
					...
					<br>
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="adddriver.php">ADD DRIVER</a>  
						 		<div class="autocomplete" style="width:100%">
					...
					<br>
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="deletedriver.php">DELETE DRIVER</a>
					 &nbsp&nbsp&nbsp  
					...
					<br>
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="addconductor.php">ADD CONDUCTOR</a>
					...
					<br>
					<div style="padding-left: 5%;width:90%">
						<font style="font-size:150%; color:white;font-family: caviar;text-align: left;"><a href="deleteconductor.php">DELETE CONDUCTOR</a>
